...
/**
 * Sets the "logout" and "logoutSuccessUrl" values. Since WebSecurityConfigurerAdapter applies the
 * LogoutConfigurer by default, no configuration is necessary.
 *
 * @author N F
 */
public class ShopifyLogout implements HttpSecurityBuilderConfigurerDelegate {
  ...
  public void applyShopifyConfig(HttpSecurityBuilder<?> http) {
    ...
    LogoutConfigurer<HttpSecurity> configurer = http.getConfigurer(LogoutConfigurer.class);
